  ...
  return (
    <div className="absolute bottom-0 z-10 flex h-[70px] w-full items-center gap-2 border border-t border-t-neutral-200 bg-white px-2 py-1">
      <div className="!aspect-square h-[50px]">
        <label
          htmlFor="fileUpload"
          className="inline-flex h-full w-full items-center justify-center gap-2 whitespace-nowrap rounded-lg bg-primary-900 text-base font-medium text-white transition-colors duration-300 hover:cursor-pointer hover:bg-primary-950 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:border-neutral-400 disabled:bg-neutral-400 disabled:text-white"
        >
          <File />
        </label>
        <input
      ...
      >
        <Input
          ...
          className="flex-grow"
        />
        <Button className="!aspect-square h-[50px]" type="submit">
          <Send />
        </Button>
      </form>
    </div>

...
// CRUD Product Custom
export const createProductCustom = async (
  data: Prisma.CustomRequestUncheckedCreateInput,
) => {
...
export const deleteProductCustom = async (
  where: Prisma.CustomRequestWhereUniqueInput,
) => {
  return await prisma.customRequest.delete({ where });
};
export const findProductCustom = async (
  where: Prisma.CustomRequestWhereUniqueInput,
) => {
